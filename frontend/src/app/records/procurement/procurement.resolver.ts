...
export class ProcurementItemsResolver implements Resolve<any>
{
  /**
   * Constructor
   */
  constructor(private _fileManagerService: ProcurementService)
  {
  }
...
export class ProcurementFolderResolver implements Resolve<any>
{
  /**
   * Constructor
   */
...
export class ProcurementItemResolver implements Resolve<any>
{
  /**
   * Constructor
   */
