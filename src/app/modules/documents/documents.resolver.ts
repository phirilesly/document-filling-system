...
export class DocumentsResolver implements Resolve<any>
{
   ...
   * Constructor
   */
  constructor(private _fileManagerService: DocumentsService)
  {
  }
...
export class DocumentsFolderResolver implements Resolve<any>
{
  /**
   * Constructor
   */
...
export class DocumentsItemResolver implements Resolve<any>
{
  /**
   * Constructor
   */
